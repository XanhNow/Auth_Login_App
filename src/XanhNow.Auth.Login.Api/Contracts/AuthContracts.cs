...
public sealed record AccountStateChangeRequest(string TargetState, string ReasonCode, string? Comment);

public sealed record AccountStateChangeResponse(Guid UserId, string Status, DateTimeOffset ChangedAtUtc);
